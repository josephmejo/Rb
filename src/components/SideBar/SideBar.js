...
const Sidebar = () => {
  ...
  const renderTabs = () => {
    switch (currentTab) {
      ...
      case 'summary':
        return <Summary data={data} config={config} onChange={onChange} />;
      case 'work':
        return <WorkTab data={data} config={config} onChange={onChange} />;
      case 'education':
        return <EducationTab data={data} config={config} onChange={onChange} />;
      case 'awards':
        return <AwardsTab data={data} config={config} onChange={onChange} />;
      case 'certifications':
        return <CertificationsTab data={data} config={config} onChange={onChange} />;
      case 'skills':
        return <SkillsTab data={data} config={config} onChange={onChange} />;
      case 'references':
        return <ReferencesTab data={data} config={config} onChange={onChange} />;
      case 'templates':
      ...
      case 'actions':
        return <ActionsTab data={data} theme={theme} config={config} dispatch={dispatch} />;
      default:
        return null;
    }
  };
